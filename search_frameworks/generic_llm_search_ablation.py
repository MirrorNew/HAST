...
ERA-like, MCTS-AHD-like, Clade-AHD-like, FunSearch-like, and
...
LOCAL_RECORD_ROOT = EXPERIMENT_ROOT / "data" / "search_framework_records" / "raw" / "tree_search_ablation_20260520"
LOCAL_DACTS_RERUN = LOCAL_RECORD_ROOT / "runs" / "DACTS-rerun"
DACTS_SRC = EXPERIMENT_ROOT / "search_frameworks" / "runtime_deps" / "dacts_search.py"
DACTS_OUTPUTS = LOCAL_DACTS_RERUN / "outputs"
...
class EraLikePolicy(SearchPolicy):
    method = "ERA-like"
    ...
    def hint(self, records: List[Dict[str, Any]], parent: Dict[str, Any]) -> str:
        return (
            "ERA-like policy: exploit the parent if it is strong, but make one clear "
...
def import_dacts_run() -> None:
    ...
    candidate = LOCAL_DACTS_RERUN / "candidates" / "candidate_01_14d7bd364063.py"
    if candidate.exists():
...
def write_manifest(args: argparse.Namespace) -> None:
    manifest = {
        ...
        "canonical_dacts": str(LOCAL_DACTS_RERUN),

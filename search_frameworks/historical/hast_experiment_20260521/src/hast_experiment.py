...
SOURCE_SEARCH = SOURCE_ROOT / "src" / "ablation_search.py"
SOURCE_12GRAPH = SOURCE_ROOT / "src" / "evaluate_final_12graphs.py"
DACTS_ROOT = WORKSPACE / "research" / "dacts_e26f_reverse_search_20260519"
...
def build_experience_block(fam: pd.DataFrame, train_cutoff: int) -> str:
    ...
    lines = [
        ...
        f"{train_cutoff} nodes of PUCT/MCTS-AHD-like/Clade-AHD-like/FunSearch-like/AlphaEvolve-like.",
...
def evaluate_12graph(run_name: str) -> None:
    ...
    colors.update({"PUCT": "#4C78A8", "MCTS-AHD-like": "#59A14F", "Clade-AHD-like": "#F28E2B", "FunSearch-like": "#B07AA1", "AlphaEvolve-like": "#9C755F"})
